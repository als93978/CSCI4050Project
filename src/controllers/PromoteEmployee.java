...
public class PromoteEmployee extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			promoteEmployee(request, response);
		} catch(Exception e) {
			e.printStackTrace();
	...
	private void promoteEmployee(HttpServletRequest request, HttpServletResponse response) throws SQLException {
		...
		String promotedMsg = "Employee successfully promoted. (UserID: " + userID + ")";
		returnMessage(request, response, promotedMsg);
	}
